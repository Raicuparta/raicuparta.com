...
const raiPal: Project = {
	...
	buttons: [
		...
		{
			icon: "Download",
			url: "https://github.com/Raicuparta/rai-pal/releases/latest/download/RaiPal.AppImage",
			label: "Download Rai Pal for Linux",
			isPrimary: true,
		},
		{
			icon: "Github",
			...
			<ProjectPage project={raiPal}>
				<Image
					...
					className={css({
						...
						width: "100%",
						shadow: "2xl",
						boxShadow: "0px 0px 20px rgba(198, 172, 255, 0.2)",
					})}
				/>
				<div className={stack()}>
					<p>
